...
- Sessions whose directory no longer exists — retired worktrees, deleted temp dirs, moved projects — are dropped entirely. They are not hidden and there is no key to bring them back.
